...
namespace LocalizeStay.Modules.Discovery.Infrastructure;

/// <summary>
/// Owns the "discovery" PostgreSQL schema. Only this module may read or write its tables (data
/// ownership rules); other modules must go through <c>LocalizeStay.Modules.Discovery.Contracts</c>
/// instead (ADR-0002: um schema por módulo dono).
/// </summary>
internal sealed class DiscoveryDbContext(DbContextOptions<DiscoveryDbContext> options) : DbContext(options), IHasOutbox
{
