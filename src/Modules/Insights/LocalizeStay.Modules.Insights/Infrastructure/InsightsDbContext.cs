...
namespace LocalizeStay.Modules.Insights.Infrastructure;

/// <summary>
/// Owns the "insights" PostgreSQL schema. Only this module may read or write its tables (data
/// ownership rules); other modules must go through <c>LocalizeStay.Modules.Insights.Contracts</c>
/// instead (ADR-0002: um schema por módulo dono).
/// </summary>
internal sealed class InsightsDbContext(DbContextOptions<InsightsDbContext> options) : DbContext(options), IHasOutbox
{
    public const string SchemaName = "insights";
