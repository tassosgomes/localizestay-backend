...
/// <summary>
/// Public contract surface for the Inventory module: DTOs, internal-API interfaces and integration events
/// consumed by other modules. Other modules may reference only this assembly — never
/// LocalizeStay.Modules.Inventory internals (architecture baseline: Domain Interaction Principles —
...
/// </summary>
public static class InventoryModuleContracts
{
